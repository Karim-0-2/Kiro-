...
module.exports.onChat = async ({ api, event, message }) => {
    try {
        ...
        const randomReplies = ["😚","Amar boss Karim ke akta gf den please 🥺" , "Hi 😀, I am here!", "What's up?", "Bolo jaan ki korte panmr jonno","chup besi Kotha kos ken 😒" , " ji bolen" , " assalamualaikum🥰 ", " hye 🙃" , "Take care yourself , Always prey to almighty Allah and enjoy your life 🥰🥰 "];
