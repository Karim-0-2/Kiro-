...
module.exports = {
  config: {
    name: "hug2",
    version: "3.1.2",
    author: "𝐒𝐡𝐚𝐡𝐚𝐝𝐚𝐭 𝐒𝐀𝐇𝐔",
    countDown: 5,
    role: 0,
    shortDescription: "hug frame generate",
    longDescription: "Send a hug photo with frame when you mention someone",
    category: "image",
    guide: {
      en: "{pn} @mention"
    }
  ...
  onStart: async function ({ event, api }) {
    ...
    if (!mention[0]) {
      return api.sendMessage("⚠️ Please mention 1 person!", threadID, messageID);
    }
