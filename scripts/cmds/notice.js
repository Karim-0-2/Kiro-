...
module.exports = {
	...
	onStart: async function ({ message, api, event, args, commandName, envCommands }) {
		...
		// Include your UID and name
		const adminInfo = "🛡 Admin: Hasib [UID: 61557991443492]";

		// Stylish text format
		const stylishText = `『 𝗛𝗮𝘀𝗶𝗯 - 𝗢𝗳𝗳𝗶𝗰𝗶𝗮𝗹 𝗡𝗼𝘁𝗶𝗰𝗲 』\n━━━━━━━━━━━━━━━━━━\n📅 Date & Time: ${timestamp}\n${userMention}\n\n📢 Notice:\n${args.join(" ")}\n━━━━━━━━━━━━━━━━━━\n${adminInfo}\n✅ Admin Announcement - Please Take Action`;
		...
		// Send final report
		const successMessage = `✅ Successfully sent notices to ${successCount} groups.`;
