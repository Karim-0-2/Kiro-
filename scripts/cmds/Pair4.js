...
module.exports = {
  config: {
    ...
    countDown: 5,
    role: 0,
    shortDescription: "Pair with BG4 (VIP only)",
    longDescription: "Finds a random partner in the group and pairs you with background 4. VIP/Owner only.",
    category: "vip-fun",
    guide: "{pn}"
  },
  ...
  onStart: async function ({ api, event, usersData }) {
    try {
      ...
      // Background 4
      const background = await loadImage("https://i.imgur.com/a3z7y9F.jpeg");
      ...
      const message = `🥰 Successful Pairing (BG4)
・${senderName} 🎀
・${matchName} 🎀
